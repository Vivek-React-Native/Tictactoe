    ...
    try {
      const options = {
        ...
        maxSize: {
          ...
          width: 900,
          height: Math.round((hp(100) / wp(100)) * 900),
        },
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <TouchableOpacity
        style={[
          styles.button,
          { backgroundColor: Colors.Black, marginTop: hp(3) },
        ]}
      ...
      <TouchableOpacity
        style={[styles.button, { backgroundColor: '#f1f', marginTop: hp(3) }]}
        onPress={() => {
      ...
      {showPdfButton && (
        <TouchableOpacity
          style={[styles.button, { backgroundColor: '#f00', marginTop: hp(3) }]}
          onPress={imagesToPDF}>
